...
try:
    ADMINS=[1683225887]
    for x in (os.environ.get("ADMINS", "1683225887 5961139833 8101405157 5660025305").split()):
        ADMINS.append(int(x))
except ValueError:
...
#Short Url or Api
SHORT_URL = os.environ.get("SHORTNER_URL", "iskerts.com")
SHORT_API = os.environ.get("SHORTNER_API", "b1fd999a61e6098c2b2924dc8c5616e3da28cc35")
